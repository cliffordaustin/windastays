  ...
  return (
    <div className="mt-5 ">
      <div className="flex flex-col">
        <h1 className="font-bold font-SourceSans text-lg">Resident fees</h1>
      ...
      <div className="flex flex-col mt-5">
        <h1 className="font-bold font-SourceSans text-lg">Non-resident fees</h1>
