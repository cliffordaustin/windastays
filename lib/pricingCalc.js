...
const adultAgeGroup = (room_types) => {
  let ageGroup = "";
  room_types.every((room_type) => {
    room_type.room_resident_availabilities.length > 0
      ? room_type.room_resident_availabilities.every((availability) => {
...
const childAgeGroup = (room_types) => {
  let ageGroup = "";
  room_types.every((room_type) => {
    room_type.room_resident_availabilities.length > 0
      ? room_type.room_resident_availabilities.every((availability) => {
...
const infantAgeGroup = (room_types) => {
  let ageGroup = "";
  room_types.every((room_type) => {
    room_type.room_resident_availabilities.length > 0
      ? room_type.room_resident_availabilities.every((availability) => {
...
const isResidentAdultAvailable = (room_types) => {
...
const isResidentChildAvailable = (room_types) => {
  let isAvailable = false;
  room_types.every((room_type) => {
    room_type.room_resident_availabilities.length > 0
      ? room_type.room_resident_availabilities.every((availability) => {
...
const isNonResidentAdultAvailable = (room_types) => {
  let isAvailable = false;
  room_types.every((room_type) => {
...
const isNonResidentChildAvailable = (room_types) => {
  let isAvailable = false;
  room_types.every((room_type) => {
    room_type.room_non_resident_availabilities.length > 0
      ? room_type.room_non_resident_availabilities.every((availability) => {
...
const isResidentInfantAvailable = (room_types) => {
  let isAvailable = false;
  room_types.every((room_type) => {
    room_type.room_resident_availabilities.length > 0
      ? room_type.room_resident_availabilities.every((availability) => {
...
const isNonResidentInfantAvailable = (room_types) => {
  let isAvailable = false;
  room_types.every((room_type) => {
    room_type.room_non_resident_availabilities.length > 0
      ? room_type.room_non_resident_availabilities.every((availability) => {
